        ...
        <Row style={{ margin: 0 }}>
            ...
            <Col>
                <ul style={{ listStyleType: 'none', marginTop: 20 }}>
                        ...
                        <li><a href="https://www.facebook.com/Encuentro-Nacional-de-Arritmias-102559971635631">{<FaFacebook />}</a></li>
                        <li><a href="https://www.instagram.com/encuentro.arritmias/">{<FaInstagram />}</a></li>
                    </div>
                </ul>
            </Col>
        </Row>
